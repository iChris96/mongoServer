...
class AuthController {
    ...
    me(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield User_1.default.findById(req.userId, { password: 0 }); //get user by req.userId (witch is provide for verifyToken middleware) from db except password value
            if (!user) {
